...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('img/diamante,png') }}">
        ...
        <div class="row border-top px-xl-5">
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="/principio" class="nav-item nav-link active">Inicio</a>
                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500" style="margin-right: 10px;">{{ Auth::user()->name }}</a>
                    @else
                        <a href="/google-auth/redirect" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500" style="background-color: #f0f0f0; color: #333; padding: 10px; margin-right: 10px;">Inicia con google</a>
                        <a href="{{ route('login') }}" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Inicia Sesión</a>
                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">Promociones</h4>
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">En mercancía de temporada</h3>
                                    <a href="shop.html" class="btn btn-light py-2 px-3">Comprar</a>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">10% De Descuento</h4>
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">En tu primer pedido</h3>
                                    <a href="shop.html" class="btn btn-light py-2 px-3">Comprar</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
                    ...
                    <h5 class="font-weight-semi-bold m-0">15 dias de garantía</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
        ...
        <div class="row px-xl-5">
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary text-center text-md-right text-white mb-2 py-5 px-5">
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        <h5 class="text-uppercase text-primary mb-3">20% de descuento</h5>
                        <h1 class="mb-4 font-weight-semi-bold">Cadenas</h1>
            ...
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary text-center text-md-left text-white mb-2 py-5 px-5">
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        <h5 class="text-uppercase text-primary mb-3">20% de descuento</h5>
                        <h1 class="mb-4 font-weight-semi-bold">Cristales</h1>
                        <a href="" class="btn btn-outline-primary py-md-2 px-md-3">Comprar ahora</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    ...
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">{{ $products->get(0)->name }}</h6>
                        <div class="d-flex justify-content-center">
                            <h6>${{ $products->get(0)->price }}</h6><h6 class="text-muted ml-2"><del>$200</del></h6>
                        </div>
                       
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="/detail" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>Más Detalles</a>
                        <form action="{{route('add')}}" method="post">
                        @csrf
                        <input type="hidden" name="id" value="{{ $products->get(0)->id }}">
                        <i class="fas fa-shopping-cart text-primary mr-1"></i> <input type="submit" name="btn" class="btn btn-sm text-dark p-0"   value="Agregar al carrito" >
                        </form>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    ...
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="text-truncate mb-3">{{ $products->get(1)->name }}</h6>
                        <div class="d-flex justify-content-center">
                            <h6>${{ $products->get(1)->price }}</h6><h6 class="text-muted ml-2"><del>$250</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>Más Detalles</a>
                        <form action="{{ route('add') }}" method="post">
                            @csrf
                            <!-- Accede al id del segundo elemento de la colección -->
        ...
        <div class="row justify-content-md-center py-5 px-xl-5">
            <div class="col-md-6 col-12 py-5">
                <div class="text-center mb-2 pb-2">
                    <h2 class="section-title px-5 mb-3"><span class="bg-secondary px-2">Mantente al tanto</span></h2>
                    <p>Recibiras correos de nuestras ofertas, promociones especiales entre otros avisos importantes.</p>
                </div>
                <form action="">
                    <div class="input-group">
